...
export PATH=$PATH:/usr/local/go/bin:/home/sinan/bin:/usr/share/code/bin/code
export GOPATH=/home/sinan/go
export PATH=$PATH:$(go env GOPATH)/bin
export PATH=$PATH:/home/sinan/.platformio/penv/bin
alias deletedups="fdupes -r -f -d -N ."
alias c=clikan

mprof () {
    rm /tmp/show_mem.plt
    cat > /tmp/show_mem.plt << EOL
...
EOL
    rm /tmp/mem.log
    echo "Dumping graph, hit CTRL+C to break"
    while true; do
